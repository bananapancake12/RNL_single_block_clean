      subroutine cft(c,ise,isa,m,iopt,aux)
!c*********************************************************************/
...
!c*
!c*   cm(j) = sum from k=0 to n-1 of cm(k)*exp(i*j*k*2*pi/n )
!c*
...
!c%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
!c*      from here down is cffti.packet.ncar adapted to real*8
!c%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
!c***********************************************************************
      ...
      implicit real*8 (a-h,o-z)
      real*8, dimension(:) ::        wa(*)      ,ifac(*)    ,ntryh(4)
...
!c***********************************************************************
  ...
  105 continue
      ...
      implicit real*8 (a-h,o-z)
      dimension cc(ido,2,l1),c1(ido,l1,2),c2(idl1,2),ch(ido,l1,2),ch2(idl1,2),wa1(l1,1)
      idot = ido/2
  ...
  108 continue
      ...
      do 110 k=1,l1
         do 109 i=4,ido,2
            ...
            c1(i-1,k,2) = wa1(l1-1,i-2)*ch(i-1,k,2)-wa1(l1,i-2)*ch(i,k,2)
  109    continue
  110 continue
      return
  ...
  113 continue
      ...
      implicit real*8 (a-h,o-z)
      dimension cc(ido,3,l1),c1(ido,l1,3),c2(idl1,3),ch(ido,l1,3),ch2(idl1,3),wa1(l1,1),wa2(ix2,1)
...
!c
  ...
  111 continue
      ...
      do 113 k=1,l1
         do 112 i=4,ido,2
            c1(i,k,2) = wa1(l1-1,i-2)*ch(i,k,2)+wa1(l1,i-2)*ch(i-1,k,2)
            c1(i-1,k,2) = wa1(l1-1,i-2)*ch(i-1,k,2)-wa1(l1,i-2)*ch(i,k,2)
            c1(i,k,3) = wa2(ix2-1,i-2)*ch(i,k,3)+wa2(ix2,i-2)*ch(i-1,k,3)
            c1(i-1,k,3) = wa2(ix2-1,i-2)*ch(i-1,k,3)-wa2(ix2,i-2)*ch(i,k,3)
  112    continue
  113 continue
      return
  ...
  116 continue
      ...
      subroutine passb4 (ido,l1,idl1,ix2,ix3,cc,c1,c2,ch,ch2,wa1,wa2,wa3)
      implicit real*8 (a-h,o-z)
      dimension cc(ido,4,l1),c1(ido,l1,4),c2(idl1,4),ch(ido,l1,4),ch2(idl1,4),wa1(l1,1),wa2(ix2,1),wa3(ix3,1)
      idot = ido/2
!c
  ...
  117 continue
      ...
      do 119 k=1,l1
         do 118 i=4,ido,2
            ...
            c1(i,k,3) = wa2(ix2-1,i-2)*ch(i,k,3)+wa2(ix2,i-2)*ch(i-1,k,3)
            c1(i-1,k,3) = wa2(ix2-1,i-2)*ch(i-1,k,3)-wa2(ix2,i-2)*ch(i,k,3)
            c1(i,k,4) = wa3(ix3-1,i-2)*ch(i,k,4)+wa3(ix3,i-2)*ch(i-1,k,4)
            c1(i-1,k,4) = wa3(ix3-1,i-2)*ch(i-1,k,4)-wa3(ix3,i-2)*ch(i,k,4)
  118    continue
  119 continue
      return
...
!c
  ...
  116 continue
      ...
      subroutine passf4 (ido,l1,idl1,ix2,ix3,cc,c1,c2,ch,ch2,wa1,wa2,wa3)
      implicit real*8 (a-h,o-z)
      dimension cc(ido,4,l1),c1(ido,l1,4),c2(idl1,4),ch(ido,l1,4),ch2(idl1,4),wa1(l1,1),wa2(ix2,1),wa3(ix3,1)
      idot = ido/2
!c
