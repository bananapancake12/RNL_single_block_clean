...
file = sprintf('output/u2_phys_%4.4dx%4.4dx%4.4d_t%5.5d.dat',xx,zz,yy,time);
%file
...
figure(2)
clf
plot(usurface(1:xx*3/2,zz*3/2/3/2),'b-')
hold on
plot(ughost(1:xx*3/2,zz*3/2/3/2),'r-')
plot(uplus1(1:xx*3/2,zz*3/2/3/2),'c-')
plot(uplus2(1:xx*3/2,zz*3/2/3/2),'m-')
title('x cut')
figure(3)
clf
plot(usurface(xx*3/2/3/2,:),'b-')
hold on
plot(ughost(xx*3/2/3/2,:),'r-')
plot(uplus1(xx*3/2/3/2,:),'c-')
plot(uplus2(xx*3/2/3/2,:),'m-')
title('z cut')
