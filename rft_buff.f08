...
!c*           mgal == nmaxt                                           */
!c*                                                                   */
!c*                                     modified rgm, march 2007      */
!c*********************************************************************/

      implicit double precision (a-h,o-z)

      double precision wsaf1(2*mgal+18)
      ...
      subroutine rft(c,isa,m,iopt,aux)
!c*********************************************************************/
